...
# ============================================================
# RUN OCR PIPELINE (Production Safe)
# ============================================================
...
def run_ocr(docname):
    ...
    if supplier_name:
        detected_supplier = frappe.db.get_value(
            "Supplier",
...
# ============================================================
# CREATE PURCHASE INVOICE (Enterprise Safe)
# ============================================================
@frappe.whitelist()
    ...
    if doc.taxes:
        ...
        for tax in doc.taxes:
            ...
            if tax.account_head in valid_tax_accounts:
                ...
                account_head = valid_tax_accounts[0] if valid_tax_accounts else None
